  ...
  constructor(config: Config<IssueListItemPanel> = null) {
    super((()=> ConfigUtils.apply(Config(IssueListItemPanel, {
      ...
      items: [
        ...
        Config(Container, {
          style: "background: #f1f1f1; padding: 1px;margin-top: 6px;",
          items: [
            Config(Container, {
              style: "padding: 3px;",
              items: [
            ...
            Config(Container, {
              ...
              plugins: [
                Config(BindComponentsPlugin, {
                  valueExpression: this.getIssuesExpression(),
        ...
        Config(Container, {
          ...
          items: [
            Config(Button, {
              ...
              text: FeedbackHubSiteimprove_properties.siteimprove_show_more,
              handler: bind(this, this.showMore),
              plugins: [
